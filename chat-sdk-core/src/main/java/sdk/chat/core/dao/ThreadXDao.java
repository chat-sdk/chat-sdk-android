...
*/
public class ThreadXDao extends AbstractDao<ThreadX, Long> {
    ...
    private Query<ThreadX> user_ThreadsQuery;

    public ThreadXDao(DaoConfig config) {
        super(config);
    }
    
    public ThreadXDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** Internal query to resolve the "threads" to-many relationship of User. */
    public List<ThreadX> _queryUser_Threads(Long userId) {
        synchronized (this) {
            if (user_ThreadsQuery == null) {
                ...
                user_ThreadsQuery = queryBuilder.build();
            }
        }
        Query<ThreadX> query = user_ThreadsQuery.forCurrentThread();
