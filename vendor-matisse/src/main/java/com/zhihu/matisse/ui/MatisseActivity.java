...
public class MatisseActivity extends AppCompatActivity implements
    ...
    public void onPause() {
        super.onPause();
        // We will hide the grid so when we come back, it isn't so obvious we are dismissing two activities
...
//            });
    ...
    private void updateBottomToolbar() {
        ...
        if (selectedCount == 0) {
            ...
            mButtonApply.setText(getString(R.string.button_done_default));
        } else if (selectedCount == 1 && mSpec.singleSelectionModeEnabled()) {
            mButtonPreview.setEnabled(true);
            mButtonApply.setText(R.string.button_done_default);
            mButtonApply.setEnabled(true);
        } else {
            mButtonPreview.setEnabled(true);
            mButtonApply.setEnabled(true);
            mButtonApply.setText(getString(R.string.button_done, selectedCount));
        }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_preview) {
            ...
            // If we have chat mode, we automatically show a preview when they click done
            if (mSpec.chatMode) {
                showPreview();
            } else {
                Intent result = new Intent();
    ...
    private void onAlbumSelected(Album album) {
        if (album.isAll() && album.isEmpty()) {
            ...
            if (mediaSelectionFragment == null) {
                ...
                mediaSelectionFragment.load(album);
            }
