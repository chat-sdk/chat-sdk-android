...
```
compile 'co.chatsdk.chatsdk:chat-sdk-ui:4.0.24'
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-adapter:4.0.24'
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-file-storage:4.0.24'
```
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-push:4.0.24'
```
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-ui:4.0.24'
```
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-social-login:4.0.24'
```
