...
- Install the demo **[Firebase](https://i.diawi.com/TWnpgq)** or **[XMPP](https://i.diawi.com/Jsdmte)** app now by clicking the link on your Android phone! 
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-push:4.0.20'
```
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-ui:4.0.20'
```
...
```
compile 'co.chatsdk.chatsdk:chat-sdk-firebase-social-login:4.0.20'
```
