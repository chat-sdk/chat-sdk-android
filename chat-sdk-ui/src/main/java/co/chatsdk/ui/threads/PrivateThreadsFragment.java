...
public class PrivateThreadsFragment extends ThreadsFragment {
    ...
    public void initViews() {
        ...
        dm.add(adapter.onLongClickObservable().subscribe(thread -> DialogUtils.showToastDialog(getContext(), "", getResources().getString(R.string.alert_delete_thread), getResources().getString(R.string.delete),
