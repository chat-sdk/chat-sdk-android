...
//        return ref;
        ...
        if (ref instanceof CollectionReference) {
            ...
            System.out.println(Fl.y.context().getString(R.string.error_mismatched_col_reference));
//            throw new Exception(Fl.y.context().getString(R.string.error_mismatched_col_reference));
            return null;
        }
...
//        return ref.document(path.last());
        ...
        if (ref instanceof DocumentReference) {
            ...
            System.out.println(Fl.y.context().getString(R.string.error_mismatched_doc_reference));
//            throw new Exception(Fl.y.context().getString(R.string.error_mismatched_col_reference));
            return null;
        }
