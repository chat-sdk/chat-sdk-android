...
//        @Override
//        public void handleMessage(CoreMessage msg) {
...
////                    UserWrapper.initWithModel(contact).metaOn();
////            }
////        });
////
////    }
...
//        {
//            if (DEBUG) Timber.d("handleUsersDetailsChange, Current CoreUser: %s", userID);
//            return;
//        }
//
...
//
//        if (DEBUG) Timber.v("handleUsersDetailsChange, CoreUser Ref: %s", userRef.getRef().toString());
//
...
////        {
////            if (DEBUG) Timber.v("CoreThread is Deleted, ID: %s", threadId);
////
...
////                    if (aLong==null)
////                    {
////                        query = query.limitToLast(DaoDefines.MAX_MESSAGES_TO_PULL);
////                    }
////                    // Deleted.
////                    else
////                    {
////                        if (DEBUG) Timber.d("CoreThread Deleted Value: %s", aLong);
////
...
////        else
////        {
////            messagesQuery = messagesQuery.limitToLast(DaoDefines.MAX_MESSAGES_TO_PULL);
////        }
////
...
//        }
//        else if (DEBUG) Timber.e("CoreThread is already handled..");
//
//    }
//
...
////
////                    if (DEBUG) Timber.i("CoreThread is added, CoreThread EntityID: %s, Listening: %s", threadFirebaseID, isListeningToThread(threadFirebaseID));
////
////
...
////                        {
////                            wrapper.addUser(UserWrapper.initWithModel(currentUser));
...
//        return NetworkManager.shared().a.core.currentUserModel().getEntityID();
//    }
//
...
//            Timber.i("handled added users, CoreThread ID: %s", s);
//
//        for (String s : handledMessagesThreadsID)
//            Timber.i("handled messages, CoreThread ID: %s", s);
//    }
