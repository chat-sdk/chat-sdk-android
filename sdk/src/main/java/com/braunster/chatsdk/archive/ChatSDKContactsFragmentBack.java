...
public class ChatSDKContactsFragmentBack extends ChatSDKBaseFragment {

    private static final String TAG = ChatSDKContactsFragmentBack.class.getSimpleName();
...
/* Initializers.*//*
    ...
    public static ChatSDKContactsFragmentBack newInstance(String eventTAG) {
        ChatSDKContactsFragmentBack f = new ChatSDKContactsFragmentBack();
    ...
    public static ChatSDKContactsFragmentBack newInstance(int loadingMode, int clickMode, Object extraData) {
        ChatSDKContactsFragmentBack f = new ChatSDKContactsFragmentBack();
    ...
    public static ChatSDKContactsFragmentBack newDialogInstance(int mode, String extraData, String title) {
        ChatSDKContactsFragmentBack f = new ChatSDKContactsFragmentBack();
        f.setDialog();
        f.setTitle(title);
        f.setExtraData(extraData);
...
/** Creates a new contact dialog.
    ...
    public static ChatSDKContactsFragmentBack newThreadUsersDialogInstance(String threadID, String title, boolean withUpdates) {
        ChatSDKContactsFragmentBack f = new ChatSDKContactsFragmentBack();
        f.setTitle(title);
    ...
    public static ChatSDKContactsFragmentBack newDialogInstance(int loadingMode, int clickMode, String title, Object extraData) {
        ChatSDKContactsFragmentBack f = new ChatSDKContactsFragmentBack();
        f.setDialog();
        f.setLoadingMode(loadingMode);
        f.setExtraData(extraData);
                        ...
                        createAndOpenThreadWithUsers(clickedUser.getMetaName(), new CompletionListenerWithData<BThread>() {
                            ...
                            public void onDone(BThread thread) {
                                ...
                                if (extraData instanceof Uri)
                                    intent.putExtra(ChatSDKChatActivity.SHARED_FILE_URI, ((Uri) extraData));
                                    // String is for text.
                                else if (extraData instanceof  String)
                                    intent.putExtra(ChatSDKChatActivity.SHARED_TEXT, ((String) extraData));
                                else
                                {
