...
public class ProfileFragmentBack extends BaseFragment implements TextView.OnEditorActionListener{

    private static final int PHOTO_PICKER_ID = 100;

    private static final String TAG = ProfileFragmentBack.class.getSimpleName();
    ...
    public static ProfileFragmentBack newInstance() {
        ProfileFragmentBack f = new ProfileFragmentBack();
        Bundle b = new Bundle();
        f.setArguments(b);
...
/** Fetching the user details from the user's metadata.*//*
    ...
    private void logout(){
        ...
        Intent intent = new Intent(getActivity(), ChatSDKLoginActivity.class);
        intent.putExtra(ChatSDKLoginActivity.FLAG_LOGGED_OUT, true);
