...
//    }
     ...
     *  If thread has more users then we will take 2/3 first users images that we could find, This will be used to make a combine image for the thread. {@link co.chatsdk.core.utils.asynctask.MakeThreadImage MakeThreadImage} */
