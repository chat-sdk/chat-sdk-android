...
// KEEP INCLUDES END
/**
 * Entity mapped to table BUSER_ACCOUNT.
 */
public class BUserAccount extends BUserAccountEntity  {
    ...
    private transient BUserAccountDao myDao;
    ...
    public BUserAccount(Long id) {
        this.id = id;
    }

    public BUserAccount(Long id, String Token, Integer type, Long user) {
        this.id = id;
        this.Token = Token;
        this.type = type;
        this.user = user;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getBUserAccountDao() : null;
    }
