...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        BUserAccountDao.createTable(db, ifNotExists);
        BUserConnectionDao.createTable(db, ifNotExists);
        BMessageDao.createTable(db, ifNotExists);
        BThreadDao.createTable(db, ifNotExists);
        BLinkDataDao.createTable(db, ifNotExists);
        BInstallationDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        BUserAccountDao.dropTable(db, ifExists);
        BUserConnectionDao.dropTable(db, ifExists);
        BMessageDao.dropTable(db, ifExists);
        BThreadDao.dropTable(db, ifExists);
        BLinkDataDao.dropTable(db, ifExists);
        BInstallationDao.dropTable(db, ifExists);
