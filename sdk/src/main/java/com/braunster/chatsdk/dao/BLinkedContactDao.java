...
*/
public class BLinkedContactDao extends AbstractDao<BLinkedContact, String> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(BLinkedContact entity, long rowId) {
        return entity.getEntityID();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(BLinkedContact entity) {
        if(entity != null) {
            return entity.getEntityID();
        } else {
            return null;
