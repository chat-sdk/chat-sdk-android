...
public class BUser extends BUserEntity {
    ...
    public Map<String, String> getUserIndexMap(){
        ...
        values.put(BDefines.Keys.BName, processForQuery(getMetaName()));
        values.put(BDefines.Keys.BEmail, processForQuery(getMetaEmail()));
    ...
    public boolean isMe(){
        return getId().longValue()
                == BNetworkManager.getCoreInterface().currentUserModel().getId().longValue();
    }
