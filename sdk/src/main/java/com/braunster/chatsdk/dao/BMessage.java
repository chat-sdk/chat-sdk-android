...
public class BMessage extends BMessageEntity {
    ...
    public boolean isSameDayAsMessage(BMessage message){
        ...
        nowCalendar.setTime(date.toDate());
        // Message time.
        Calendar messageCalendar = Calendar.getInstance();
        messageCalendar.setTime(message.getDate().toDate());
        // Compare
    ...
    public boolean isMine(){
        return getSender().equals(BNetworkManager.getCoreInterface().currentUserModel());
    }
