...
public class BMessage extends Entity<BMessage>  {
    ...
    public BMessage(java.util.Date date, String entityID, Boolean dirty, String resources, String resourcesPath, String text, int type, String OwnerThread, String Sender) {
        this.date = date;
        this.entityID = entityID;
        this.dirty = dirty;
