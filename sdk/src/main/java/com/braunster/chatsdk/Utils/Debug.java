...
public class Debug {
    ...
    public static final boolean BFacebookManager = true;
    public static final boolean BNetworkManager = true;
    ...
    /*Activities*/
    public static final boolean BaseActivity = true;
