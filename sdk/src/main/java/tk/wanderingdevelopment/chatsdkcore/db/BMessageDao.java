...
import com.braunster.chatsdk.dao.BMessage.DateTimeConverter;
...
public class BMessageDao extends AbstractDao<BMessage, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SenderId = new Property(11, Long.class, "senderId", false, "SENDER_ID");
        public final static Property ThreadId = new Property(12, Long.class, "threadId", false, "THREAD_ID");
    }
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, BMessage entity) {
        stmt.clearBindings();
        ...
        if (threadId != null) {
            stmt.bindLong(13, threadId);
        }
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, BMessage entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(BMessage entity) {
    ...
    public BMessage readEntity(Cursor cursor, int offset) {
        BMessage entity = new BMessage( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getLong(offset + 11), // senderId
            cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12) // threadId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BMessage entity, int offset) {
        ...
        entity.setSenderId(cursor.isNull(offset + 11) ? null : cursor.getLong(offset + 11));
        entity.setThreadId(cursor.isNull(offset + 12) ? null : cursor.getLong(offset + 12));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(BMessage entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(BMessage entity) {
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN BUSER T0 ON T.\"SENDER_ID\"=T0.\"_id\"");
