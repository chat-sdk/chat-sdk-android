...
public class BLinkedAccountDao extends AbstractDao<BLinkedAccount, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, BLinkedAccount entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BLinkedAccount entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(BLinkedAccount entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(BLinkedAccount entity) {
