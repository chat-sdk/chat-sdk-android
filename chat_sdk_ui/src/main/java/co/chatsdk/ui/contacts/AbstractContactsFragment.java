...
public class AbstractContactsFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NM.events().sourceOnMain()
                .filter(PredicateFactory.type(EventType.ContactsChanged))
        ...
        if (loadingMode != MODE_USE_SOURCE)
            ...
            switch (loadingMode) {
                ...
                case MODE_LOAD_CONTACT_THAT_NOT_IN_THREAD:
                    List<BUser> users1 = NM.contact().contacts();
                    thread = DaoCore.fetchEntityWithProperty(BThread.class, BThreadDao.Properties.Id, extraData);
...
//                        showLoading();
//                        NetworkManager.getCoreInterface().getFollowers((String) extraData)
...
//                        sourceUsers = new ArrayList<BUser>();
//                        showLoading();
//                        NetworkManager.getCoreInterface().getFollows((String) extraData).subscribe(new Observer<BUser>() {
//                            @Override
//                            public void onSubscribe(Disposable d) {
//                            }
//
...
//        }
    ...
    public interface ContactListListener{
        void onContactClicked(BUser user);
    }
