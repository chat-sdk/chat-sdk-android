...
public abstract class ChatSDKAbstractUsersListAdapter<E extends ChatSDKAbstractUsersListAdapter.AbstractUserListItem> extends BaseAdapter {
    ...
    public ChatSDKAbstractUsersListAdapter(AppCompatActivity activity){
        mActivity = activity;
    ...
    public ChatSDKAbstractUsersListAdapter(AppCompatActivity activity, boolean isMultiSelect){
        mActivity = activity;
    ...
    public ChatSDKAbstractUsersListAdapter(AppCompatActivity activity, List<E> userItems){
        mActivity = activity;
    ...
    public ChatSDKAbstractUsersListAdapter(AppCompatActivity activity, List<E> userItems, boolean multiSelect){
        mActivity = activity;
