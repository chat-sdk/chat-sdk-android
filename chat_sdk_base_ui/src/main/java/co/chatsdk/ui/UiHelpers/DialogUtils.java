...
public class DialogUtils {
    ...
    public static ImagePopupWindow getImageMessageDialog(final Context context, String data, final ImagePopupWindow.LoadTypes loadingType, BMessage message){
        return getImageDialog(context, data, loadingType, true, message.getEntityID());
    }
