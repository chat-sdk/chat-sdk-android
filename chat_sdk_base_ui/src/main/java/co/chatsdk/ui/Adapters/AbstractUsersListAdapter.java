 ...
 */
public abstract class AbstractUsersListAdapter<E extends AbstractUsersListAdapter.AbstractUserListItem> extends BaseAdapter {

    private static final String TAG = AbstractUsersListAdapter.class.getSimpleName();
    ...
    public AbstractUsersListAdapter(AppCompatActivity activity, boolean isMultiSelect){
        mActivity = activity;
    ...
    public AbstractUsersListAdapter(AppCompatActivity activity, List<E> userItems){
        mActivity = activity;
    ...
    public AbstractUsersListAdapter(AppCompatActivity activity, List<E> userItems, boolean multiSelect){
        mActivity = activity;
...
//                Log.d(TAG, "Report EntityID: " + s);
     ...
     * * * */
    protected interface UserListItemMaker<E extends AbstractUsersListAdapter.AbstractUserListItem> {
