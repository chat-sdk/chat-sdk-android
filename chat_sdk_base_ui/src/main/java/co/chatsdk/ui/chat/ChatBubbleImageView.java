...
public class ChatBubbleImageView extends AppCompatImageView /*implements View.OnTouchListener */{
    ...
    public static final int BubbleDefaultPressedColor = Color.parseColor(DaoDefines.Defaults.BubbleDefaultColor);
    public static final int BubbleDefaultColor = Color.parseColor(DaoDefines.Defaults.BubbleDefaultPressedColor);
